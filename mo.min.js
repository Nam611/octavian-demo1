...
!function(t, e) {
  ...
  , function(t, e, r) {
      ...
      r(20))
        , S = function(t) {
          function e() {
              return a["default"](this, e),
              u["default"](this, t.apply(this, arguments))
          }
          return h["default"](e, t),
          ...
          e.prototype.tune = function(e) {
              return t.prototype.tune.call(this, e),
              this._getMaxSizeInChain(),
              this
          }
          ,
          e.prototype.then = function(e) {
              return t.prototype.then.call(this, e),
              this._getMaxSizeInChain(),
              this
          }
          ,
          e.prototype._vars = function() {
              return t.prototype._vars.call(this),
              this._lastSet = {},
          ...
          e.prototype._drawEl = function() {
              ...
              var t = this._props
                , e = this.el.style;
              if (this._isPropChanged("opacity") && (e.opacity = t.opacity),
              !this.isForeign) {
          ...
          e.prototype._tuneNewOptions = function(e) {
              return t.prototype._tuneNewOptions.call(this, e),
              null != e && n["default"](e).length ? void this._setElStyles() : 1
          }
          ,
          ...
          e.prototype._getMaxSizeInChain = function() {
              ...
              0), e = 0, r = 0; r < this._modules.length; r++)
  ...
  , function(t, e, r) {
      ...
      var s = r(23)
        ...
        , d = function(t) {
          ...
          ,
          e.prototype._tuneNewOptions = function(e) {
              null != e && (t.prototype._tuneNewOptions.call(this, e),
      ...
      var s = r(28)
        ...
        , w = function(t) {
          ...
          e.prototype.tune = function(t) {
              return null == t ? this : (this._saveTimelineOptions(t),
          ...
          e.prototype._masterThen = function(t) {
              ...
              return this._masterSwirls.push(e),
              e
          }
          ,
        ...
        , T = function(t) {
          ...
          e.prototype._extendDefaults = function() {
              ...
              for (var e = f["default"](t), r = 0; r < e.length; r++) {
                  ...
                  w.isDelta(t[i]) || x[i] ? s && !o && this._drawProps.push(i) : (this._parseOption(i, t[i]),
                  "el" === i && (this._props.el = w.parseEl(t.el),
          ...
          e.prototype._resetMergedFlags = function(e) {
              return t.prototype._resetMergedFlags.call(this, e),
              e.props = this._props,
          ...
          e.prototype._mergeThenProperty = function(t, e, r) {
              ...
              if (w.isTweenProp(t) || this._nonMergeProps[t] || i)
                  return r;
              var s = {};
      ...
      var s = r(23)
        ...
        , c = function() {
          function t() {
              ...
              this._createTween(),
              this) : a["default"].error('No "el" option specified, aborting')
          }
      ...
      r(10))
        ...
        , m = function(t) {
          function e() {
              ...
              return null == s._props.name && s._setSelfName(),
              r = s,
              a["default"](s, r)
          }
          return u["default"](e, t),
          ...
          e.prototype._setSelfName = function() {
              ...
              c["default"][t] = null == c["default"][t] ? 1 : ++c["default"][t],
              this._props.name = this._props.nameBase + " " + c["default"][t]
          }
          ,
          ...
          e.prototype._extendDefaults = function() {
              ...
              null != e.backwardEasing && (e.backwardEasing = d["default"].parseEasing(e.backwardEasing),
          ...
          e.prototype._update = function(t, e, r, i) {
              ...
              i && null != r) {
                  ...
                  this._start(t, a)) : (this._prevTime = t - 1,
                  this._repeatComplete(t, a),
                  this._complete(t, a)) : -1 === i && (r ? (this._prevTime = t - 1,
                  this._repeatComplete(t, a),
                  this._complete(t, a)) : this._prevTime >= s.startTime && this._prevTime <= s.endTime && (this._prevTime = t + 1,
                  this._repeatStart(t, a),
                  this._start(t, a),
                  this._isCompleted = !0)),
                  this._prevTime = void 0
              }
              return t > n && t < s.endTime ? this._progressTime = t - n : n >= t ? this._progressTime = 0 : t >= s.endTime && (this._progressTime = s.repeatTime + 1e-11),
          ...
          e.prototype._updateInActiveArea = function(t) {
              ...
              if (t === e.endTime) {
                  ...
                  return this._setProgress(l ? 0 : 1, t, l),
              ...
              i + s >= e.startTime) {
                  ...
                  _ && (this._onEdge = 1),
                  y && (this._onEdge = -1),
                  this._wasUknownUpdate && (t > this._prevTime && (this._start(t, l),
                  this._repeatStart(t, l),
                  this._firstUpdate(t, l)),
                  t < this._prevTime && (this._complete(t, l),
                  this._repeatComplete(t, l),
                  this._firstUpdate(t, l),
                  this._isCompleted = !1)),
                  _) {
                  ...
                  t > this._prevTime && (!this._isStarted && this._prevTime <= e.startTime && (this._start(t, l),
                  this._repeatStart(t, l),
                  this._isStarted = !1,
                  this._isRepeatStart = !1),
                  this._firstUpdate(t, l)),
                  y && (0 !== this.progress && 1 !== this.progress && p != n && this._repeatStart(t, h),
                  p !== n || this._wasUknownUpdate || (this._complete(t, l),
                  this._repeatComplete(t, l),
                  this._firstUpdate(t, l),
                  this._isCompleted = !1),
                  this._repeatComplete(t, l)),
                  "delay" === p && (u > o && this._repeatComplete(t, l),
                  o === u && o > 0 && this._repeatStart(t, l)),
                  t > this._prevTime ? (0 === d && this._repeatStart(t, l),
                  t !== e.endTime && this._setProgress(l ? 1 - d : d, t, l)) : (t !== e.endTime && this._setProgress(l ? 1 - d : d, t, l),
          ...
          e.prototype._setProp = function(e, r) {
              t.prototype._setProp.call(this, e, r),
              this._calcDimentions()
          }
          ,
          e.prototype._assignProp = function(e, r) {
              null == r && (r = this._defaults[e]),
              "easing" === e && (r = d["default"].parseEasing(r),
              r._parent = this);
        ...
        , m = function(t) {
          ...
          e.prototype.append = function() {
              ...
              for (var i = e, s = Array.isArray(i), o = 0, i = s ? i : n["default"](i); ; ) {
                  ...
                  var p = a;
                  f["default"].isArray(p) ? this._appendTimelineArray(p) : this._appendTimeline(p, this._timelines.length),
                  this._calcDimentions()
              }
              return this
          }
          ...
          e.prototype.stop = function(e) {
              return t.prototype.stop.call(this, e),
              this._stopChildren(e),
              this
          }
          ,
          e.prototype.reset = function() {
              return t.prototype.reset.call(this),
              this._resetChildren(),
              this
          }
          ,
          ...
          ,
          e.prototype._declareDefaults = function() {
              null != this._o.duration && (f["default"].error('Duration can not be declared on Timeline, but "' + this._o.duration + '" is. You probably want to use Tween instead.'),
              this._o.duration = 0),
              t.prototype._declareDefaults.call(this),
  ...
  , function(t, e, r) {
      ...
      function() {
          ...
          t.prototype._listenVisibilityChange = function() {
              "undefined" != typeof document.hidden ? (this._visibilityHidden = "hidden",
              this._visibilityChange = "visibilitychange") : "undefined" != typeof document.mozHidden ? (this._visibilityHidden = "mozHidden",
              this._visibilityChange = "mozvisibilitychange") : "undefined" != typeof document.msHidden ? (this._visibilityHidden = "msHidden",
              this._visibilityChange = "msvisibilitychange") : "undefined" != typeof document.webkitHidden && (this._visibilityHidden = "webkitHidden",
      ...
      var s = r(23)
        ...
        , y = function(t) {
          function e() {
              ...
              return i._transformTweenOptions(),
  ...
  , function(t, e, r) {
      ...
      var s = r(28)
        ...
        , y = function(t) {
          ...
          return h["default"](e, t),
          e.prototype.then = function(t) {
              if (null == t || !n["default"](t).length)
                  return 1;
              var e = this._history[this._history.length - 1]
                , r = (this._modules[this._modules.length - 1],
          ...
          e.prototype._mergeEndLoop = function(t, e, r) {
              ...
              for (var i in r)
                  if ("parent" != i) {
                      ...
                      if (o = this._checkStartValue(i, o),
                      null != s) {
          ...
          e.prototype._mergeThenProperty = function(t, e, r) {
              ...
              if (_["default"].isTweenProp(t) || this._nonMergeProps[t] || n)
                  return r;
              if (_["default"].isObject(r) && null != r.to && (i = r.curve,
              s = r.easing,
              r = r.to),
              this._isDelta(r))
      ...
      var s = r(28)
        ...
        , y = function(t) {
          ...
          e.prototype._transformHistoryRecord = function(t, e, r, i, s) {
              ...
              if (0 === t) {
                  if (i[e] = r,
                  f["default"].isTweenProp(e) && "duration" !== e)
                      return null;
              ...
              if (this._isDelta(n)) {
                  var u;
                  return i[e] = (u = {},
                  u[r] = f["default"].getDeltaEnd(n),
                  u),
                  null
              }
              return i[e] = r,
              this._isRewriteNext(n, o) ? r : null
          }
          ,
          e.prototype._isRewriteNext = function(t, e) {
              ...
              var r = t === e
                ...
                , n = !1
                , o = !1;
              return s && i ? f["default"].getDeltaEnd(t) == f["default"].getDeltaStart(e) && (o = !0) : i && (n = f["default"].getDeltaStart(e) === "" + t),
              r || n || o
          }
          ,
      ...
      var b = g._defaults
        , S = function() {
          ...
          t.prototype._isDelta = function(t) {
              var e = m.isObject(t);
              return e = e && !t.unit,
              !(!e || m.isArray(t) || m.isDOM(t))
          }
          ,
          t.prototype._parseColorDelta = function(t, e) {
              if ("strokeLinecap" === t)
                  return m.warn("Sorry, stroke-linecap property is not animatable yet, using the start(#{start}) value instead", e),
                  {};
          ...
          t.prototype._makeColorObj = function(t) {
              ...
              if ("#" !== t[0]) {
                  var o = "r" === t[0] && "g" === t[1] && "b" === t[2]
                    , a = void 0;
                  o && (a = t),
                  o || (this._shortColors[t] ? a = this._shortColors[t] : (m.div.style.color = t,
      ...
      var s = r(18)
        ...
        , l = function() {
          ...
          t.prototype._setProp = function(t, e) {
              if ("object" === ("undefined" == typeof t ? "undefined" : n["default"](t)))
                  for (var r in t)
          ...
          t.prototype._hide = function() {
              this.el && (this._props.isSoftHide ? u["default"].setPrefixedStyle(this.el, "transform", "scale(0)") : this.el.style.display = "none",
              this._isShown = !1)
          }
          ,
          ...
          t.prototype._parseOptionString = function(t) {
              return "string" == typeof t && t.match(/stagger/) && (t = u["default"].parseStagger(t, this._index)),
              "string" == typeof t && t.match(/rand/) && (t = u["default"].parseRand(t)),
              t
          }
          ,
          t.prototype._parsePositionOption = function(t, e) {
              return u["default"].unitOptionMap[t] && (e = u["default"].parseUnit(e).string),
              e
          }
          ,
          ...
          t.prototype._parseProperty = function(t, e) {
              return "parent" === t ? u["default"].parseEl(e) : (e = this._parsePreArrayProperty(t, e),
          ...
          t.prototype._calcCurrentProps = function(t, e) {
              for (var r in this._deltas) {
                  ...
                  if ("array" === i.type) {
                      var o;
                      u["default"].isArray(this._props[r]) ? (o = this._props[r],
                      o.length = 0) : o = [];
  ...
  , function(t, e, r) {
      ...
      i = function() {
          ...
          t.prototype.style = function(t, e, r) {
              ...
              if ("object" == typeof e) {
                  ...
                  o = []; n--; )
                      i = s[n],
                      r = e[i],
                      o.push(this.setPrefixedStyle(t, i, r));
                  return o
              }
          ...
          t.prototype.getRadialPoint = function(t) {
              var e, r, i, s;
              return null == t && (t = {}),
              r = .017453292519943295 * (t.angle - 90),
          ...
          t.prototype.getPrefix = function() {
              ...
              i = Array.prototype.slice.call(r).join("").match(/-(moz|webkit|ms)-/),
              e = (i || "" === r.OLink && ["", "o"])[1],
          ...
          t.prototype.strToArr = function(t) {
              var e;
              return e = [],
              "number" != typeof t || isNaN(t) ? (t.trim().split(/\s+/gim).forEach(function(t) {
                  return function(r) {
          ...
          t.prototype.makeColorObj = function(t) {
              ...
              return "#" === t[0] && (u = /^#?([a-f\d]{1,2})([a-f\d]{1,2})([a-f\d]{1,2})$/i.exec(t),
              i = {},
              u && (o = 2 === u[1].length ? u[1] : u[1] + u[1],
          ...
          t.prototype.parseStagger = function(t, e) {
              var r, i, s, n, o, a;
              return a = t.split(/stagger\(|\)$/)[1].toLowerCase(),
              s = a.split(/(rand\(.*?\)|[^\(,\s]+)(?=\s*,|\s*$)/gim),
              a = s.length > 3 ? (r = this.parseUnit(this.parseIfRand(s[1])),
          ...
          t.prototype.parseDelta = function(t, e, r) {
              ...
              !isNaN(parseFloat(c)) || c.match(/rand\(/) || c.match(/stagger\(/))
                  if ("strokeDasharray" === t || "strokeDashoffset" === t || "origin" === t) {
                      ...
                      this.callbacksMap[t] || this.tweenOptionMap[t] || (this.unitOptionMap[t] ? (o = this.parseUnit(this.parseStringOption(o, r)),
          ...
          t.prototype.isDOM = function(t) {
              var e;
              return null == t ? !1 : (e = "number" == typeof t.nodeType && "string" == typeof t.nodeName,
              "object" == typeof t && e)
          }
          ,
          ...
          t.prototype.delta = function(t, e) {
              ...
              r && i ? (s = {},
              s[t] = e,
              s) : void this.error("delta method expects Strings or Numbers at input but got - " + t + ", " + e)
          }
          ,
          ...
          t.prototype.parsePath = function(t) {
              var e;
              return "string" == typeof t ? "m" === t.charAt(0).toLowerCase() ? (e = document.createElementNS(this.NS, "path"),
          ...
          t.prototype.parseEl = function(t) {
              return s.isDOM(t) ? t : ("string" == typeof t && (t = document.querySelector(t)),
  ...
  , function(t, e, r) {
      ...
      i = function() {
          ...
          t.prototype.vars = function() {
              return this.getScaler = o.bind(this.getScaler, this),
              this.resize = a,
          ...
          t.prototype.curveToPath = function(t) {
              ...
              return h = document.createElementNS(o.NS, "path"),
              d = t.start,
              l = {
                  x: d.x + t.shift.x,
                  y: d.x + t.shift.y
          ...
          t.prototype.postVars = function() {
              return this.props.pathStart = o.clamp(this.props.pathStart, 0, 1),
              ...
              this.addEvent(this.container, "onresize", this.getScaler)) : void 0) : (o.error("Path has no coordinates to work with, aborting"),
              !0)) : (o.error('Missed "el" option. It could be a selector, DOMNode or another module.'),
              !0)
          }
          ,
          ...
          t.prototype.getPath = function() {
              var t;
              return t = o.parsePath(this.props.path),
              t ? t : this.props.path.x || this.props.path.y ? this.curveToPath({
                  start: {
                      x: 0,
                      y: 0
                  },
          ...
          t.prototype.run = function(t) {
              ...
              if (t) {
                  ...
                  for (r in t)
                      i = t[r],
                      o.callbacksMap[r] || o.tweenOptionMap[r] ? (o.warn('the property "' + r + '" property can not be overridden on run yet'),
                      delete t[r]) : this.history[0][r] = i;
                  this.tuneOptions(t)
              }
          ...
          t.prototype.setElPosition = function(t, e, r) {
              var i, s, n, a;
              return n = 0 !== this.angle ? "rotate(" + this.angle + "deg)" : "",
          ...
          t.prototype._getCurrentAngle = function(t, e, r) {
              ...
              this.props.isAngle || null != this.props.angleOffset || s ? (n = this.path.getPointAtLength(e - 1),
              a = t.y - n.y,
              p = t.x - n.x,
              i = Math.atan(a / p),
              !isFinite(i) && (i = 0),
              this.angle = i * o.RAD_TO_DEG,
              "function" != typeof this.props.angleOffset ? this.angle += this.props.angleOffset || 0 : this.angle = this.props.angleOffset.call(this, this.angle, r)) : this.angle = 0
          }
          ,
          ...
          t.prototype._setTransformOrigin = function(t) {
              var e, r;
              return this.props.transformOrigin ? (e = "function" == typeof this.props.transformOrigin,
              r = e ? this.props.transformOrigin(this.angle, t) : this.props.transformOrigin,
              o.setPrefixedStyle(this.el, "transform-origin", r)) : void 0
          }
          ,
          ...
          t.prototype.setBlur = function(t) {
              return this.isMotionBlurReset ? void 0 : (this.filter.setAttribute("stdDeviation", t.blur.x + "," + t.blur.y),
          ...
          t.prototype.angToCoords = function(t) {
              ...
              r = Math.cos(e),
              i = Math.sin(e),
              r = 0 > r ? Math.max(r, -.7) : Math.min(r, .7),
              i = 0 > i ? Math.max(i, -.7) : Math.min(i, .7),
              {
                  x: 1.428571429 * r,
                  y: 1.428571429 * i
              }
      ...
      i = function() {
          ...
          t.prototype.back = {
              ...
              inout: function(t) {
                  var e;
                  return e = 2.5949095,
                  (t *= 2) < 1 ? .5 * t * t * ((e + 1) * t - e) : .5 * ((t -= 2) * t * ((e + 1) * t + e) + 2)
              }
          },
          t.prototype.elastic = {
              "in": function(t) {
                  ...
                  0 === t ? 0 : 1 === t ? 1 : (e = 1,
                  i = r / 4,
                  -(e * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t - i) * Math.PI / r)))
              },
              out: function(t) {
                  var e, r, i;
                  return i = void 0,
                  ...
                  0 === t ? 0 : 1 === t ? 1 : (e = 1,
                  i = r / 4,
                  e * Math.pow(2, -10 * t) * Math.sin(2 * (t - i) * Math.PI / r) + 1)
              },
              inout: function(t) {
                  var e, r, i;
                  return i = void 0,
                  ...
                  0 === t ? 0 : 1 === t ? 1 : (e = 1,
                  i = r / 4,
                  (t *= 2) < 1 ? -.5 * e * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t - i) * Math.PI / r) : e * Math.pow(2, -10 * (t -= 1)) * Math.sin(2 * (t - i) * Math.PI / r) * .5 + 1)
              }
          },
          t.prototype.bounce = {
              "in": function(t) {
          ...
          t.prototype.parseEasing = function(t) {
              ...
              r = typeof t,
              "string" === r ? "m" === t.charAt(0).toLowerCase() ? this.path(t) : (t = this._splitEasing(t),
              e = this[t[0]],
              e ? e[t[1]] : (u.error('Easing with name "' + t[0] + '" was not found, fallback to "linear.none" instead'),
              this.linear.none)) : u.isArray(t) ? this.bezier.apply(this, t) : t
          }
          ,
          t.prototype._splitEasing = function(t) {
              var e, r, i;
              return "function" == typeof t ? t : "string" == typeof t && t.length ? (i = t.split("."),
  ...
  , function(t, e, r) {
      ...
      e["default"] = function(t, e) {
          if ("function" != typeof e && null !== e)
              throw new TypeError("Super expression must either be null or a function, not " + ("undefined" == typeof e ? "undefined" : u["default"](e)));
      ...
      var s = r(18)
        ...
        , y = function(t) {
          ...
          e.prototype.castStrokeDash = function(t) {
              ...
              "object" === n["default"](e[t]) && (r = "%" === e[t].unit ? this.castPercent(e[t].value) : e[t].value,
              e[t] = 0 === r ? r = "" : r)
          }
          ,
  ...
  , function(t, e, r) {
      !function() {
          ...
          for (s = ["webkit", "moz"],
          e = 0,
          o = window; e < s.length && !o.requestAnimationFrame; )
              n = s[e],
              o.requestAnimationFrame = o[n + "RequestAnimationFrame"],
              t = o[n + "CancelAnimationFrame"],
              o.cancelAnimationFrame = t || o[n + "CancelRequestAnimationFrame"],
              ++e;
          r = !o.requestAnimationFrame || !o.cancelAnimationFrame,
          (/iP(ad|hone|od).*OS 6/.test(o.navigator.userAgent) || r) && (i = 0,
  ...
  , function(t, e, r) {
      !function(t) {
          var e, r, i;
          return null == t.performance && (t.performance = {}),
          Date.now = Date.now || function() {
              return (new Date).getTime()
          }
          ,
          null == t.performance.now ? (e = (null != (r = t.performance) && null != (i = r.timing) ? i.navigationStart : void 0) ? performance.timing.navigationStart : Date.now(),
          ...
          return r = function() {
              ...
              t.prototype.redefineProto = function() {
                  ...
                  i = function() {
                      ...
                      s = n.length; s > i; t = ++i)
                          r = n[t],
                          null != r.prototype && o.push(function(t) {
                              var r, i;
                              ...
                              function(r) {
                                  ...
                                  return i = function() {
                                      var t;
                                      return (this !== window || this !== document) && (t = "onresize" === arguments[0] && !this.isAnyResizeEventInited,
                                      t && e.handleResize({
                                          args: arguments,
                                          that: this
                                      })),
              ...
              t.prototype.handleResize = function(t) {
                  ...
                  null != (a = i.contentWindow) && (a.onresize = function(t) {
                      return function(e) {
              ...
              t.prototype.initTimer = function(t) {
                  ...
                  this.interval = setInterval(function(i) {
                      return function() {
                          var s, n;
                          return n = t.offsetWidth,
                          s = t.offsetHeight,
                          n !== r || s !== e ? (i.dispatchEvent(t),
                          r = n,
                          e = s) : void 0
                      }
              ...
              t.prototype.destroy = function() {
                  ...
                  i = n.length; i > r; t = ++r)
                      s = n[t],
                      null != s.prototype && o.push(function(t) {
                          var e;
                          return e = t.prototype.addEventListener || t.prototype.attachEvent,
        ...
        , c = function(t) {
          ...
          e.prototype._draw = function() {
              var e = this._props
                ...
                , n = r.radius !== e.radius;
              (i || s || n) && (this.el.setAttribute("transform", this._getScale()),
              r.radiusX = e.radiusX,
              r.radiusY = e.radiusY,
              r.radius = e.radius),
          ...
          e.prototype._render = function() {
              if (!this._isRendered) {
                  ...
                  var t = this._props;
                  t.parent.innerHTML = '<svg id="js-mojs-shape-canvas" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"><g id="js-mojs-shape-el">' + this.getShape() + "</g></svg>",
  ...
  , function(t, e, r) {
      ...
      s = function(t) {
          ...
          e.prototype._draw = function() {
              ...
              l = this._props,
              this._props.points && (c = null != this._props.radiusX ? this._props.radiusX : this._props.radius,
              ...
              !(o && a && n))) {
                  ...
                  h = "M" + t + ", " + m + " ",
                  s = p = 0,
                  d = l.points; d >= 0 ? d > p : p > d; s = d >= 0 ? ++p : --p)
                      h += "L" + t + ", " + r + " ",
                      t += _,
                      u += i,
                      r = -1 === g ? m - f : m,
                      g = -g;
                  return this._length = u,
  ...
  , function(t, e, r) {
      ...
      s = function(t) {
          ...
          e.prototype._draw = function() {
              ...
              !(o && a && s)) {
                  for (m = 360 / this._props.points,
                  null == this._radialPoints ? this._radialPoints = [] : this._radialPoints.length = 0,
                  i = p = 0,
                  _ = this._props.points; _ >= 0 ? _ > p : p > _; i = _ >= 0 ? ++p : --p)
  ...
  , function(t, e, r) {
      ...
      s = function(t) {
          ...
          e.prototype._draw = function() {
              ...
              r && i ? void 0 : (u = this._props.width / 2,
      ...
      s = function(t) {
          ...
          e.prototype._draw = function() {
              ...
              !(s && n && i))) {
                  ...
                  _ = d - u,
                  r = o = 0,
                  l = this._props.points; l >= 0 ? l > o : o > l; r = l >= 0 ? ++o : --o)
                      d = "" + (r * y + _),
                      t += "M" + c + ", " + d + " L" + f + ", " + d + " ";
              ...
              t.prototype.generate = function(t, r, i, s) {
                  ...
                  for (S = P = 0; 4 > P; S = ++P)
                      ...
                      "number" != typeof d || isNaN(d) || !isFinite(d))
                          return this.error("Bezier function expects 4 arguments");
                  return 0 > t || t > 1 || 0 > i || i > 1 ? this.error("Bezier x values should be > 0 and < 1") : (u = 4,
                  l = .001,
                  c = 1e-7,
                  h = 10,
                  T = 11,
                  ...
                  g = function(e) {
                      return f || k(),
                      t === r && i === s ? e : 0 === e ? 0 : 1 === e ? 1 : y(b(e), r, s)
                  }
                  ,
                  D = "bezier(" + [t, r, i, s] + ")",
                  g.toStr = function() {
  ...
  , function(t, e, r) {
      ...
      i = function() {
          ...
          t.prototype._preSample = function() {
              ...
              o = [],
              t = e = 0,
              n = this._precompute; n >= 0 ? n >= e : e >= n; t = n >= 0 ? ++e : --e)
                  s = t * this._step,
                  r = this.pathLength * s,
                  i = this.path.getPointAtLength(r),
                  o.push(this._samples[t] = {
                      point: i,
                      length: r,
                      progress: s
                  });
          ...
          t.prototype._findBounds = function(t, e) {
              ...
              a = t.length,
              this._boundsPrevProgress > e ? (p = 0,
              i = "reverse") : (p = a,
              i = "forward"),
              "forward" === i ? (f = t[0],
              s = t[t.length - 1]) : (f = t[t.length - 1],
              s = t[0]),
              n = o = h = this._boundsStartIndex,
              c = p; c >= h ? c > o : o > c; n = c >= h ? ++o : --o) {
                  if (d = t[n],
          ...
          t.prototype._findApproximate = function(t, e, r, i) {
              ...
              u = p.x / this._rect,
              s.closeEnough(t, u, this._eps) ? this._resolveY(p) : --i < 1 ? this._resolveY(p) : (a = {
                  point: p,
                  length: n
              },
          ...
          t.prototype._normalizePath = function(t) {
              var e, r, i, s, n, o;
              return o = /[M|L|H|V|C|S|Q|T|A]/gim,
              s = t.split(o),
              s.shift(),
              e = t.match(o),
              n = 0,
  ...
  , function(t, e, r) {
      ...
      o = function() {
          var t;
          return t = 1 <= arguments.length ? u.call(arguments, 0) : [],
          t.length > 1 ? t = t.sort(p) : t[0].value = a(t[0]),
          function(e) {
              var r, i;
              return r = n(t, e),
              -1 !== r ? (i = t[r].value,
              r === t.length - 1 && e > t[r].to ? 1 : "function" == typeof i ? i(e) : i) : void 0
          }
      }
      ,
      i = function(t) {
  ...
  , function(t, e, r) {
      ...
      u._sample._proximate = u._proximate,
      e["default"] = u._sample
  }
  , function(t, e, r) {
      t.exports = {
  ...
  , function(t, e, r) {
      r(62),
      r(63),
      t.exports = r(64).Symbol
  }
  , function(t, e, r) {
      r(65),
      t.exports = r(64).Object.setPrototypeOf
  }
  , function(t, e, r) {
      var i = r(66);
  ...
  , function(t, e, r) {
      ...
      : S
        ...
        , j = function(t, e, r) {
          return r && n(A, e) ? (r.enumerable ? (n(t, D) && t[D][e] && (t[D][e] = !1),
          r = P(r, {
              enumerable: w(0, !1)
          })) : (n(t, D) || S(t, D, w(1, {})),
          t[D][e] = !0),
        ...
        , H = function(t, e) {
          var r = b(t = v(t), e);
          return !r || !n(A, e) || n(t, D) && t[D][e] || (r.enumerable = !0),
          r
      }
        , N = function(t) {
        ...
        , q = function(t) {
          if (void 0 !== t && !Y(t)) {
              ...
              (r || !m(e)) && (e = function(t, e) {
                  return r && (e = r.call(this, t, e)),
                  Y(e) ? void 0 : e
              }
              ),
              i[1] = e,
  ...
  , function(t, e, r) {
      ...
      t.exports = r(72)(Array, "Array", function(t, e) {
          ...
          s(1)) : "keys" == e ? s(0, r) : "values" == e ? s(0, t[r]) : s(0, [r, t[r]])
      }, "values"),
      n.Arguments = n.Array,
      i("keys"),
      i("values"),
  ...
  , function(t, e, r) {
      ...
      t.exports = function(t) {
          return function(e, r) {
              ...
              return 0 > p || p >= u ? t ? "" : void 0 : (n = a.charCodeAt(p),
              55296 > n || n > 56319 || p + 1 === u || (o = a.charCodeAt(p + 1)) < 56320 || o > 57343 ? t ? a.charAt(p) : n : t ? a.slice(p, p + 2) : (n - 55296 << 10) + (o - 56320) + 65536)
          }
      }
  }
  , function(t, e, r) {
  ...
  , function(t, e, r) {
      var i = r(77)
        ...
        , o = "prototype"
        , a = function(t, e, r) {
          var p, u, l, h = t & a.F, c = t & a.G, f = t & a.S, d = t & a.P, _ = t & a.B, y = t & a.W, m = c ? s : s[e] || (s[e] = {}), g = c ? i : f ? i[e] : (i[e] || {})[o];
          c && (r = e);
          for (p in r)
              u = !h && g && p in g,
              u && p in m || (l = u ? g[p] : r[p],
              m[p] = c && "function" != typeof g[p] ? r[p] : _ && u ? n(l, i) : y && g[p] == l ? function(t) {
                  var e = function(e) {
                      return this instanceof t ? new t(e) : t(e)
                  };
                  return e[o] = t[o],
                  e
              }(l) : d && "function" == typeof l ? n(Function.call, l) : l,
              d && ((m[o] || (m[o] = {}))[p] = l))
      };
      a.F = 1,
      a.G = 2,
  ...
  , function(t, e, r) {
      ...
      t.exports = {
          set: Object.setPrototypeOf || ("__proto__"in {} ? function(t, e, s) {
              try {
                  s = r(103)(Function.call, i(Object.prototype, "__proto__").set, 2),
                  s(t, []),
  ...
  , function(t, e, r) {
      ...
      t.exports = r(82)(function() {
          ...
          for (var r = s(t), o = arguments, a = o.length, p = 1, u = i.getKeys, l = i.getSymbols, h = i.isEnum; a > p; )
              for (var c, f = n(o[p++]), d = l ? u(f).concat(l(f)) : u(f), _ = d.length, y = 0; _ > y; )
